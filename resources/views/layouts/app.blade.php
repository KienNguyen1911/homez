...
<!-- Mirrored from creativelayers.net/themes/homez-html/index3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Feb 2024 11:47:08 GMT -->
<head>
<meta charset="utf-8">
        ...
        <div class="row align-items-center justify-content-between">
          <div class="col-auto">
            <div class="d-flex align-items-center justify-content-between">
              <div class="logos mr40 mr10-lg">
                <a class="header-logo logo2" href="index-2.html"><img src="images/header-logo2.svg" alt="Header Logo"></a>
                <a class="header-logo logo1" href="index-2.html"><img src="images/header-logo2.svg" alt="Header Logo"></a>
              </div>
          ...
          <div class="col-auto">
            <div class="d-flex align-items-center">
              ...
              <a class="ud-btn btn-dark mx-2 mx-xl-4" href="page-dashboard-add-property.html">Add Property<i class="fal fa-arrow-right-long"></i></a>
              <a class="sidemenu-btn filter-btn-right" href="#"><img src="images/icon/nav-icon-dark.svg" alt=""></a>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="body_content">
      ...
      <div class="container">
        ...
        <div class="row wow fadeInUp" data-wow-delay="300ms">
          <div class="col-sm-6 col-lg-3">
            <a href="page-property-single-v1.html">
              <div class="position-relative mb50 mb20-md d-flex align-items-center">
                <div class="city-img flex-shrink-0"><img src="images/listings/cp-s-1.png" alt=""></div>
          ...
          <div class="col-sm-6 col-lg-3">
            <a href="page-property-single-v1.html">
              <div class="position-relative mb50 mb20-md d-flex align-items-center">
                <div class="city-img flex-shrink-0"><img src="images/listings/cp-s-2.png" alt=""></div>
                <div class="flex-shrink-1 ms-3">
          ...
          <div class="col-sm-6 col-lg-3">
            <a href="page-property-single-v1.html">
              <div class="position-relative mb50 mb20-md d-flex align-items-center">
                <div class="city-img flex-shrink-0"><img src="images/listings/cp-s-3.png" alt=""></div>
                <div class="flex-shrink-1 ms-3">
          ...
          <div class="col-sm-6 col-lg-3">
            <a href="page-property-single-v1.html">
              <div class="position-relative mb50 mb20-md d-flex align-items-center">
                <div class="city-img flex-shrink-0"><img src="images/listings/cp-s-4.png" alt=""></div>
                <div class="flex-shrink-1 ms-3">
          ...
          <div class="col-sm-6 col-lg-3">
            <a href="page-property-single-v1.html">
              <div class="position-relative mb50 mb20-md d-flex align-items-center">
                <div class="city-img flex-shrink-0"><img src="images/listings/cp-s-5.png" alt=""></div>
                <div class="flex-shrink-1 ms-3">
          ...
          <div class="col-sm-6 col-lg-3">
            <a href="page-property-single-v1.html">
              <div class="position-relative mb50 mb20-md d-flex align-items-center">
                <div class="city-img flex-shrink-0"><img src="images/listings/cp-s-6.png" alt=""></div>
                <div class="flex-shrink-1 ms-3">
          ...
          <div class="col-sm-6 col-lg-3">
            <a href="page-property-single-v1.html">
              <div class="position-relative mb50 mb20-md d-flex align-items-center">
                <div class="city-img flex-shrink-0"><img src="images/listings/cp-s-7.png" alt=""></div>
                <div class="flex-shrink-1 ms-3">
          ...
          <div class="col-sm-6 col-lg-3">
            <a href="page-property-single-v1.html">
              <div class="position-relative mb50 mb20-md d-flex align-items-center">
                <div class="city-img flex-shrink-0"><img src="images/listings/cp-s-8.png" alt=""></div>
                <div class="flex-shrink-1 ms-3">
    ...
    <section class="pb30-md bgc-dark">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="dots_nav_light navi_pagi_bottom_center slider-dib-sm slider-5-grid owl-carousel owl-theme wow fadeInUp" data-wow-delay="300ms">
              <div class="item">
                <a href="page-property-single-v1.html">
        ...
        <div class="row align-items-md-center wow fadeInRight" data-wow-delay="300ms">
          ...
          <div class="col-md-6 col-lg-5 offset-lg-1 wow fadeInLeft" data-wow-delay="500ms">
            <div class="main-title2">
              ...
              <p class="paragraph fz15">As the complexity of buildings to increase, the <br class="d-none d-lg-block"> field of architecture.</p>
            </div>
        ...
        <div class="row">
          <div class="col-lg-7 col-xl-6 wow fadeInLeft">
            <div class="cta-style3">
              ...
              <a href="page-contact.html" class="ud-btn btn-thm">Register Now <i class="fal fa-arrow-right-long"></i></a>
            </div>
          </div>
...
<!-- Mirrored from creativelayers.net/themes/homez-html/index3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Feb 2024 11:47:16 GMT -->
</html>